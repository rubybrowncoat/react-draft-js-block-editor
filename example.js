...
var data = {
  "entityMap": {
    ...
    "2": {
      ...
      "data": {
        "src": "http://www.virtualizationsoftware.com/wp-content/uploads/2013/07/horizon-700x325.jpg"
      }
    },
    "3": {
      "type": "LINK",
      "mutability": "MUTABLE",
      "data": {
        "url": "http://www.virtualizationsoftware.com/wp-content/uploads/2013/07/horizon-700x325.jpg"
      }
    }
  },
  "blocks": [{
    ...
    "key": "4jprg",
    "text": "This is a caption block. It is an opinionated block that can be added after special atomic blocks (image, video, embed) to be used as their captions when exporting to HTML or other formats instead of adding nested draft-js editors for simplicity.",
    "type": "caption",
    "depth": 0,
    "inlineStyleRanges": [{
      "offset": 10,
...
var App = React.createClass({
  ...
  render: function render() {
    return React.createElement(
      'div',
      null,
      React.createElement(DraftJsBlockEditor, { value: data })
    );
  }
});
...
},{"react":undefined,"react-dom":undefined,"react-draft-js-block-editor":undefined}]},{},[1]);
